...
### 3 - Instalando todos os seus programas

Agora faremos a última parte, iremos executar o script para instalar todos os aplicativos que estamos acostumados a utilizar na máquina.

* **NOTA:** O script abaixo é um exemplo com programas comuns que eu utilizo na minha máquina, mas que você deverá adaptar ao seu uso.
